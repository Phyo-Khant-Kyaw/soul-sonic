<x-backend>
	...
	<main class="app-content">
        <div class="app-title">
            <div>
                <h1> <i class="icofont-list"></i> Song Form </h1>
            </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="tile">
                    <div class="tile-body">
                        <form action="{{ route('backside.song.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                             ...
                             <div class="form-group row">
                               ...
                               <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                   <select class="form-control" name="artist_id" id="myartist">
        ...
        <script type="text/javascript">
            ...
            headers:{
                'X_CSRF_TOKEN':$('meta[name="csrf-token"]').attr('content')
                    ...
                    $.post('/albumartist',{id:id},function(res){
                        console.log(res);
                        var html="";

                        $.each(res,function(i,v){
                            html+=`<option value="${v.artist_id}">${v.name}</option>`;
                        })
                        $("#myartist").html(html);
